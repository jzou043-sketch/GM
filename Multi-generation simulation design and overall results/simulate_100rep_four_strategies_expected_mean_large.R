...
make_balanced_pairs <- function(selected_females, selected_males, female_score, male_score) {
  female_ord <- selected_females[order(female_score[selected_females], decreasing = TRUE)]
  male_ord <- selected_males[order(male_score[selected_males], decreasing = TRUE)]
